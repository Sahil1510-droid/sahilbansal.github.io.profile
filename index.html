...
<head>
  ...
  <meta charset="UTF-8" />
  <meta name="google-site-verification" content="MwD-5A-QiTB5Bv_M9yYhGcK0ZgOgzOQKz1CsYBng22g" />
  <meta http-equiv="X-UA-Compatible" content="IE=edge" />
  <meta name="viewport" content="width=device-width, initial-scale=1" />
  <title>Sahil Bansal &#128516;</title>
  ...
  <style>
    ...
    .change::after {
      ...
      animation: animation 6.5s steps(1000) infinite;
      width: 0ch;
      color: white;
    }
...
<script type="text/javascript" src="https://www.quickchat.ai/user_kit/quickchat8vqb7j.min.js" id="quickchat_script" scenario_id="7vzpfqqmwt"></script>
...
<body id="top">
    ...
    <div class="container">
      ...
      <nav class="navbar container">
        ...
        <ul class="navbar-list">
          ...
          <li>
            <a href="https://resume.io/r/ZFxKJBpDp" target="_blank" class="btn btn-primary">Download CV</a>
          </li>

          <li>
            <a href="https://drive.google.com/file/d/15_3SrWJxrZ_OtBMXaA6e2nGOHL9Rk_Lj/view?usp=sharing" target="_blank" class="btn btn-primary">Download Video</a>
          </li>
    ...
    <article>
      ...
      <section class="hero" id="home">
        ...
        <div class="container">
          ...
          <div class="hero-banner">
            ...
            <img class="avatar img-cover" src="./assets/images/hero-banner.jpg" alt="Sahil's Photo" loading="lazy">
            ...
            <img src="./assets/images/rotate-img.png" width="169" height="172" alt="I'm developer from India" class="rotate-img">
          </div>
          <div class="hero-content">
            <h2 class="hero-title">
              <span>Hello, I'm</span>
              <strong>Sahil Bansal</strong>
              <p class="change">I'm a </p>
            </h2>
            <p class="hero-text">
              Unleash your brand's digital potential with our expert digital marketer.
              We fuel growth, amplify visibility, and deliver measurable results in the dynamic online landscape.
            </p>
            <div class="btn-group">
            ...
            <br>
            <div>
            <a href="https://www.instagram.com/sahilbansal.sb/" target="_blank" class="fa fa-instagram"></a>
            <a href="https://www.linkedin.com/in/sahil-bansal-224853218/" target="_blank" class="fa fa-linkedin"></a>
            </div>
          </div>
        </div>
      </section>
      ...
      <section class="section about" id="about">
        <div class="container">
          ...
          <figure class="about-banner">
            <img src="./assets/images/about-banner.jpg" width="800" height="652" loading="lazy" alt="Sahil's Photo"
              class="img-cover" />

            <img src="./assets/images/absolute-image.jpg" width="800" height="717" loading="lazy" alt="Sahil's Photo"
              class="abs-img" />
          </figure>

          <div class="about-content">
            <p class="section-subtitle">I'm a Front-End Developer</p>
            ...
            <p class="section-text">
              A front-end developer creates attractive and user-friendly
              interfaces for websites and applications. They use HTML, CSS,
              and JavaScript to bring designs to life, optimize performance,
              and ensure compatibility across different browsers. They
              collaborate with designers and stay updated on the latest web
              technologies.
            </p>
      ...
      <section class="section about" id="about">
        <div class="container">
          ...
          <figure class="about-banner">
            <img src="./assets/images/absolute-image.jpg" width="800" height="652" loading="lazy" alt="Sahil's Photo"
              class="img-cover" />

            <img src="./assets/images/about-banner.jpg" width="800" height="717" loading="lazy" alt="Sahil's Photo"
              class="abs-img" />
          </figure>

          <div class="about-content">
            <p class="section-subtitle">I'm a Digital Marketer</p>

            <h2 class="h2 section-title">
              I Make Ads that Help People
            </h2>

            <p class="section-text">
              A digital marketer promotes products or brands using online
              strategies like SEO, social media, and paid advertising. They
              analyze data to improve campaigns and stay updated with the
      ...
      <section class="section portfolio" id="portfolio">
        <div class="container">
          ...
          <p class="section-text">
            Embark on a journey of innovation and creativity - Discover the magic within my extraordinary projects!
          </p>

          <ul class="portfolio-list">
            <li>
              <a href="#" class="portfolio-card" style="
      ...
      <section class="section skills" id="skills">
        <div class="container">
          ...
          <p class="section-text">
            Skills that shine like stars - Unleashing my full potential with every endeavor!
          </p>
          ...
          <ul class="skills-list">
            ...
            <li class="skills-item">
              <div class="wrapper" style="width: 75%">
                <h3 class="skills-title">Digital Marketing</h3>
            ...
            <li class="skills-item">
              <div class="wrapper" style="width: 90%">
                <h3 class="skills-title">Video Editing</h3>
            ...
            <li class="skills-item">
              <div class="wrapper" style="width: 90%">
                <h3 class="skills-title">Prompt Engineering</h3>
            ...
            <li class="skills-item">
              <div class="wrapper" style="width: 80%">
                <h3 class="skills-title">Email Marketing</h3>
            ...
            <li class="skills-item">
              <div class="wrapper" style="width: 90%">
                <h3 class="skills-title">Microsoft Office 365</h3>
            ...
            <li class="skills-item">
              <div class="wrapper" style="width: 80%">
                <h3 class="skills-title">Blockchain</h3>
              ...
              <ul class="contact-list">
                ...
                <li class="contact-item">
                  ...
                  <div>
                    ...
                    <a href="mailto:hello@sahil.com" class="contact-item-link">sahilbansal152001@gmail.com</a>
                  </div>
                </li>
                ...
                <li class="contact-item">
                  ...
                  <div>
                    ...
                    <a href="tel:+91 89689-67835" class="contact-item-link">+91 89689-67835</a>
                  </div>
                </li>
              </ul>
            </div>
      ...
      <section class="section blog" id="blog">
        <div class="container">
          ...
          <p class="section-text">
            Unlock a world of inspiration - Explore my latest blogfolio adventures!
          </p>
          ...
          <ul class="blog-list">
            <li>
              <div class="blog-card">
                ...
                <h3 class="card-title">
                  <a href="#">Jim Morisson Says when the musics over turn off the
                    light</a>
                </h3>
              </div>
            </li>
  ...
  <footer class="footer">
    <div class="container">
      <p class="copyright">
        &copy; <?php echo date("Y"); ?> <a href="#" class="copyright-link">Sahil Bansal</a>. All
        Rights Reseverd
      </p>
